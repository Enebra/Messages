...
namespace Services {
  ...
  {
    static readonly string __ServiceName = "Services.BiometricFacialSevice";
    ...
    /// <summary>Client for BiometricFacialSevice</summary>
    [System.Obsolete("Client side interfaced will be removed in the next release. Use client class directly.")]
    public interface IBiometricFacialSeviceClient
    {
      global::DataTypes.Faces Acquire(global::DataTypes.Photo request, Metadata headers = null, DateTime? deadline = null, CancellationToken cancellationToken = default(CancellationToken));
      global::DataTypes.Faces Acquire(global::DataTypes.Photo request, CallOptions options);
      AsyncUnaryCall<global::DataTypes.Faces> AcquireAsync(global::DataTypes.Photo request, Metadata headers = null, DateTime? deadline = null, CancellationToken cancellationToken = default(CancellationToken));
      AsyncUnaryCall<global::DataTypes.Faces> AcquireAsync(global::DataTypes.Photo request, CallOptions options);
      global::Services.PopulationCreationResponse CreatePopulation(global::DataTypes.Photos request, Metadata headers = null, DateTime? deadline = null, CancellationToken cancellationToken = default(CancellationToken));
      global::Services.PopulationCreationResponse CreatePopulation(global::DataTypes.Photos request, CallOptions options);
      AsyncUnaryCall<global::Services.PopulationCreationResponse> CreatePopulationAsync(global::DataTypes.Photos request, Metadata headers = null, DateTime? deadline = null, CancellationToken cancellationToken = default(CancellationToken));
      AsyncUnaryCall<global::Services.PopulationCreationResponse> CreatePopulationAsync(global::DataTypes.Photos request, CallOptions options);
      global::Services.FaceSearchResponse Verify(global::Services.VerificationData request, Metadata headers = null, DateTime? deadline = null, CancellationToken cancellationToken = default(CancellationToken));
      global::Services.FaceSearchResponse Verify(global::Services.VerificationData request, CallOptions options);
      AsyncUnaryCall<global::Services.FaceSearchResponse> VerifyAsync(global::Services.VerificationData request, Metadata headers = null, DateTime? deadline = null, CancellationToken cancellationToken = default(CancellationToken));
      AsyncUnaryCall<global::Services.FaceSearchResponse> VerifyAsync(global::Services.VerificationData request, CallOptions options);
      global::Services.FaceSearchResponse Identify(global::Services.IdentificationData request, Metadata headers = null, DateTime? deadline = null, CancellationToken cancellationToken = default(CancellationToken));
      global::Services.FaceSearchResponse Identify(global::Services.IdentificationData request, CallOptions options);
      AsyncUnaryCall<global::Services.FaceSearchResponse> IdentifyAsync(global::Services.IdentificationData request, Metadata headers = null, DateTime? deadline = null, CancellationToken cancellationToken = default(CancellationToken));
      AsyncUnaryCall<global::Services.FaceSearchResponse> IdentifyAsync(global::Services.IdentificationData request, CallOptions options);
    }

    /// <summary>Interface of server-side implementations of BiometricFacialSevice</summary>
    [System.Obsolete("Service implementations should inherit from the generated abstract base class instead.")]
    public interface IBiometricFacialSevice
    {
      global::System.Threading.Tasks.Task<global::DataTypes.Faces> Acquire(global::DataTypes.Photo request, ServerCallContext context);
      global::System.Threading.Tasks.Task<global::Services.PopulationCreationResponse> CreatePopulation(global::DataTypes.Photos request, ServerCallContext context);
      global::System.Threading.Tasks.Task<global::Services.FaceSearchResponse> Verify(global::Services.VerificationData request, ServerCallContext context);
      global::System.Threading.Tasks.Task<global::Services.FaceSearchResponse> Identify(global::Services.IdentificationData request, ServerCallContext context);
    }

    /// <summary>Base class for server-side implementations of BiometricFacialSevice</summary>
    public abstract class BiometricFacialSeviceBase
    {
    ...
    public class BiometricFacialSeviceClient : ClientBase<BiometricFacialSeviceClient>, IBiometricFacialSeviceClient
    #pragma warning restore 0618
    {
      public BiometricFacialSeviceClient(Channel channel) : base(channel)
      {
      }
      public BiometricFacialSeviceClient(CallInvoker callInvoker) : base(callInvoker)
      {
      }
      ///<summary>Protected parameterless constructor to allow creation of test doubles.</summary>
      protected BiometricFacialSeviceClient() : base()
      {
      }
      ///<summary>Protected constructor to allow creation of configured clients.</summary>
      protected BiometricFacialSeviceClient(ClientBaseConfiguration configuration) : base(configuration)
      {
      }
      ...
      protected override BiometricFacialSeviceClient NewInstance(ClientBaseConfiguration configuration)
      {
        return new BiometricFacialSeviceClient(configuration);
      }
    }

    /// <summary>Creates a new client for BiometricFacialSevice</summary>
    ...
    /// <summary>Creates service definition that can be registered with a server</summary>
    #pragma warning disable 0618
    public static ServerServiceDefinition BindService(BiometricFacialSeviceBase serviceImpl)
    #pragma warning restore 0618
    {
      return ServerServiceDefinition.CreateBuilder(__ServiceName)
          .AddMethod(__Method_Acquire, serviceImpl.Acquire)
