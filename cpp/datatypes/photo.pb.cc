        ...
        if (tag == 48) {
         parse_biotype:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          set_biotype(static_cast< ::DataTypes::BiometricDataType >(value));
        } else {
          goto handle_unusual;
        }
