...
void protobuf_AssignDesc_datatypes_2funit_2eproto() {
  ...
  UnitConfiguration_descriptor_ = file->message_type(3);
  ...
  UnitLocationState_descriptor_ = file->message_type(4);
